...
[![Stars](https://img.shields.io/github/stars/andrewwango/apex-nexus-monolith?style=social)](https://github.com/andrewwango/apex-nexus-monolith) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) [![Kimi Powered](https://img.shields.io/badge/Powered_by-Moonshot_Kimi_K2-blue)](https://moonshot.ai) [![Python 3.11+](https://img.shields.io/badge/python-3.11%2B-blue)](https://python.org)  
...
![Demo GIF](https://files.oaiusercontent.com/file-aB3cD5eF7gH9iJ1kL2mN4oP5?se=2025-11-25T23%3A59%3A59Z&sp=r&sv=2024-11-04&sr=b&rscc=max-age%3D1209600%2C%20immutable&rscd=attachment%3B%20filename%3Dapex-nexus-demo-v3.gif&sig=...)
...
```mermaid
graph TD
    A[User Query] --> B[Meta-Cognition v2 + Ethical Governance]
    B --> C{Trigger Cortices?}
    C -->|Research| D[Deep Research Engine + Socratic Council]
    C -->|Code| E[Stateful Python REPL + venv support]
    C -->|Memory| F[Hybrid SQLite + ChromaDB + Git]
    C -->|Uncertainty| G[Uncertainty Resolution Engine]
    C -->|Planning| H[Workflow Orchestration]
    D & E & F & G & H --> I[Response Synthesis]
    I --> J[Reinforcement Episode + Memory Consolidation]
    J --> K[Anomaly Detection → Self-Healing]
    K -->|Critical| L[Rebirth / Rollback via Git]
```
...
```bash
git clone https://github.com/andrewwango/apex-nexus-monolith.git
cd apex-nexus-monolith
...
![Star History](https://api.star-history.com/svg?repos=andrewwango/apex-nexus-monolith&type=Date)
